            ...
            <div className="bg-white shadow p-4 rounded mx-auto" style={{ maxWidth: "600px" }}>
                ...
                <Form>
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control type="number" placeholder="Enter Faculty ID" />
                    </Form.Group>
                    <Form.Group className="mb-3">
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control type="text" placeholder="Enter Experience (e.g., 10+ Years)" />
                    </Form.Group>
                    <Form.Group className="mb-3">
                        <Form.Label>Image URL:</Form.Label>
                        <Form.Control type="text" placeholder="Enter Image URL" />
                    </Form.Group>
                    <Button variant="primary" className="w-100">Add Faculty</Button>
                </Form>
            </div>
